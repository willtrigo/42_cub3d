...
/*   Updated: 2025/03/09 00:53:42 by maurodri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	camera_init(t_game *game, t_camera *out, int num_rays)
{
	...
	out->caml = vec2f_add(vec2f_unit_vector(angle - fov1_2), game->player.pos);
	out->camr = vec2f_add(vec2f_unit_vector(angle + fov1_2), game->player.pos);
